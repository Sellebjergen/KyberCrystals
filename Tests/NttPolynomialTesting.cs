...
public class NttPolynomialTesting
{
    ...
    public void Ntt_OnBabyKyber_GivesCorrectResults()
    {
        ...
        // TODO: there is a bug, but we are getting really close!
        
        Assert.True(TestHelpers.ComparePolynomialLists(expected, res));
    }

    [Fact(Skip = "Seems like the java implementation does some weird stuff in their ntt, maybe montgomery spaces?")]
